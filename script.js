...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function setupSplashScreen() {
        ...
        if (splineCanvas) {
            ...
            app.load('https://prod.spline.design/iW-0Yq2x5dc537v1/scene.splinecode', {
                // To allow the CSS background to show through, we can make the spline background transparent
                // Note: This might not work if the scene itself has a solid background object.
                // The most reliable way is to re-export the spline scene with a transparent background.
            });
        }
        ...
        playBtn.addEventListener('click', () => {
            ...
            setTimeout(() => {
                ...
                // Use a short delay before fading in to prevent layout jump
                setTimeout(() => gameContainer.classList.add('fade-in'), 50);
